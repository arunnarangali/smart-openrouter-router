...
def select_candidates(ranked_models, requested_model_raw):
    ...
    if requested_model in {"smart-router/fast", "fast", "smart-router/plan", "plan"}:
    ...
    if requested_model in {"smart-router/best", "best", "smart-router/build", "build"} or requested_model.startswith("smart-router/") or not requested_model_raw:
